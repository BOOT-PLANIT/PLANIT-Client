...
export const generateCalendarDates = (): DateData[] => [
  ...
  { date: new Date(2025, 9, 14), status: "present" },
  { date: new Date(2025, 9, 15), status: "present" },
  { date: new Date(2025, 9, 16), status: "present" },
  { date: new Date(2025, 9, 17), status: "present" },
  { date: new Date(2025, 9, 18), status: "annual" },
  { date: new Date(2025, 9, 21), status: "present" },
  { date: new Date(2025, 9, 22), status: "present" },
  { date: new Date(2025, 9, 23), status: "present" },
  { date: new Date(2025, 9, 24), status: "present", isCurrentUnit: true },
  { date: new Date(2025, 9, 25), status: "present" },
